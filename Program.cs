...
{	/// </summary>
    ...
    class Program
    {
        ...
        static DataTable getDataTable()
        {
            ...
            result.Rows.Add(new object[] {  "Sunny", "Hot", "High","Weak", false }); //D1 sol alta alta não N
            result.Rows.Add(new object[] { "Sunny", "Hot", "High",  "Strong",false }); //D2 sol alta alta sim N
            result.Rows.Add(new object[] { "Overcast", "Hot", "High", "Weak", true }); //D3 nebulado alta alta não P
            result.Rows.Add(new object[] { "Rain", "Mild", "High", "Weak", true }); //D4 chuva alta alta não P
            result.Rows.Add(new object[] { "Rain", "Cool", "Normal", "Weak", true }); //D5 chuva baixa normal não P
            result.Rows.Add(new object[] { "Rain", "Cool", "Normal", "Strong", false }); //D6 chuva baixa normal sim N
            result.Rows.Add(new object[] { "Overcast", "Cool", "Normal", "Strong", true }); //D7 nebulado baixa normal sim P
            result.Rows.Add(new object[] { "Sunny", "Mild", "High", "Weak", false }); //D8 sol suave alta não N
            result.Rows.Add(new object[] { "Sunny", "Cool", "Normal", "Weak", true }); //D9 sol baixa normal não P
            result.Rows.Add(new object[] { "Rain", "Mild", "Normal", "Weak", true }); //D10 chuva suave normal não P
            result.Rows.Add(new object[] { "Sunny", "Mild", "Normal", "Strong", true }); //D11 sol suave normal sim P
            result.Rows.Add(new object[] { "Overcast", "Mild", "High", "Strong", true }); //D12 nebulado suave alta sim P
            result.Rows.Add(new object[] { "Overcast", "Hot", "Normal", "Weak", true }); //D13 nebulado alta normal não P
            result.Rows.Add(new object[] { "Rain", "Mild", "High", "Strong", false }); //D14 chuva suave alta sim N
        ...
        {
            Attribute ceu = new Attribute("Outlook", new string[] { "Rain", "Sunny", "Overcast" });
            Attribute temperatura = new Attribute("Temperature", new string[] { "Cool", "Hot", "Mild" });
            Attribute humidade = new Attribute("Humidity", new string[] { "High", "Normal" });
            Attribute vento = new Attribute("Wind", new string[] { "Strong", "Weak" });
